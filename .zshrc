...
# AWS
alias awls="aws ec2 describe-instances --output text --query 'Reservations[*].Instances[*].[State.Name, Tags[?Key==\`Name\`].Value | [1], PublicDnsName]' | sed -e 's/^running/R/g' | sed -e 's/^stopped/S/g' | peco"
